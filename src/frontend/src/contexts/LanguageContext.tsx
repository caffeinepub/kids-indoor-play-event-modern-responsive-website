...
const translations: Record<Language, Translations> = {
  en: {
    ...
    about: {
      ...
      subtitle:
        "Oklahoma City's premier indoor playground designed with your child's safety and fun in mind",
      cleanSafeTitle: "Clean, Safe Play Areas",
      description1:
        "Our facility features state-of-the-art play equipment specifically designed for children's safety. Every area is regularly cleaned and maintained to ensure a hygienic environment for your little ones.",
      description2:
        "We provide a complete indoor play experience with various play zones including soft play areas, climbing structures, slides, and interactive games suitable for children aged 6 months to 10 years.",
      ...
      gripSocksDesc:
        "Required for all children - $2/pair + Tax (available for purchase)",
      adultPolicy: "Adult Policy:",
      adultPolicyDesc:
        "Each child admission includes 2 free adults. Additional adults $5 per person + Tax",
    },
    playAreas: {
      title: "Our Play Areas",
      subtitle:
        "Explore our diverse play zones designed to engage, entertain, and inspire children of all ages",
      ...
      equipmentDesc:
        "All our play equipment meets or exceeds safety standards and is regularly inspected and maintained. We prioritize your child's safety while ensuring maximum fun!",
    },
    safety: {
      title: "Important Safety Notice",
      gripSocksRequired: "Grip Socks Required",
      gripSocksDesc:
        "All children must wear grip socks for safety while playing in our facility. This helps prevent slips and falls on our play equipment.",
      ...
      mandatoryNote:
        "Grip socks are mandatory for all children. If you don't have grip socks, you can purchase them at our facility before play begins.",
    },
    admission: {
    ...
    groups: {
      ...
      callAheadDesc:
        "Please contact us in advance to schedule your group visit and ensure we can accommodate your party.",
      phone: "Phone:",
      email: "Email:",
    },
    birthday: {
    ...
    monthly: {
      ...
      subtitle:
        "Unlimited play for a full month - the best value for frequent visitors!",
      ...
      greatValueDesc:
        "Visit just 5 times and you've already saved money compared to daily admission! Perfect for families who love to play often.",
    ...
    requirements: {
      ...
      acknowledgment:
        "Acknowledgment of inherent risks in physical play activities",
      ...
      includedAdultsDesc:
        "Each child admission includes 2 free adults to supervise and accompany the child during play.",
      mustRemain:
        "Adults must remain on premises to supervise their children at all times.",
      additionalAdults: "Additional Adults",
      additionalAdultsDesc:
      ...
      parentsRemain:
        "Parents/guardians must remain on premises during their child's visit",
      childrenSupervised:
        "Children must be supervised by an adult at all times",
      facilityAges:
        "Facility is designed for children ages 6 months to 10 years",
      foodDrinks: "Food and drinks are allowed in designated areas only",
      followRules:
        "Please follow all posted safety rules and staff instructions",
    ...
    waiver: {
      ...
      childrenInfoDesc:
        "Enter information for up to 6 children (at least one required)",
      child: "Child",
      ...
      agreeRequired:
        "Please agree to the liability waiver and photo release terms",
  ...
  es: {
    ...
    about: {
      ...
      subtitle:
        "El principal parque de juegos interior de Oklahoma City diseñado pensando en la seguridad y diversión de su hijo",
      cleanSafeTitle: "Áreas de Juego Limpias y Seguras",
      description1:
        "Nuestra instalación cuenta con equipos de juego de última generación diseñados específicamente para la seguridad de los niños. Cada área se limpia y mantiene regularmente para garantizar un ambiente higiénico para sus pequeños.",
      description2:
        "Proporcionamos una experiencia de juego interior completa con varias zonas de juego que incluyen áreas de juego suave, estructuras para escalar, toboganes y juegos interactivos adecuados para niños de 6 meses a 10 años.",
      safetyFirst: "Seguridad Primero",
      safetyDesc:
        "Todo el equipo cumple con los estándares de seguridad y se inspecciona regularmente",
      cleanEnvironment: "Ambiente Limpio",
      cleanDesc:
        "Limpieza profunda diaria y desinfección de todas las áreas de juego",
      ageAppropriate: "Apropiado para la Edad",
      ageDesc: "Diseñado para niños de 6 meses a 10 años",
      supervisedPlay: "Juego Supervisado",
      supervisedDesc:
        "Los padres pueden relajarse mientras los niños juegan en un ambiente seguro",
      importantRequirements: "Requisitos Importantes",
      waiverRequired: "Exención Requerida:",
      waiverDesc:
        "Todos los niños deben tener una exención firmada antes de jugar",
      gripSocks: "Calcetines Antideslizantes:",
      gripSocksDesc:
        "Requeridos para todos los niños - $2/par + Impuesto (disponibles para compra)",
      adultPolicy: "Política de Adultos:",
      adultPolicyDesc:
        "Cada admisión de niño incluye 2 adultos gratis. Adultos adicionales $5 por persona + Impuesto",
    },
    playAreas: {
      title: "Nuestras Áreas de Juego",
      subtitle:
        "Explore nuestras diversas zonas de juego diseñadas para involucrar, entretener e inspirar a niños de todas las edades",
      toddlerZone: "Zona de Niños Pequeños",
      toddlerDesc:
        "Área de juego suave y segura diseñada específicamente para nuestros visitantes más jóvenes (6 meses - 3 años)",
      climbingStructures: "Estructuras para Escalar",
      climbingDesc:
        "Equipo de escalada multinivel con toboganes y túneles para juego activo",
      activePlayZone: "Zona de Juego Activo",
      activeDesc:
        "Área de alta energía con cursos de obstáculos y desafíos físicos",
      interactiveGames: "Juegos Interactivos",
      interactiveDesc:
        "Juegos digitales y físicos que fomentan el aprendizaje a través del juego",
      creativeCorner: "Rincón Creativo",
      creativeDesc:
        "Estaciones de arte, manualidades y juego imaginativo para mentes creativas",
      adventureArea: "Área de Aventura",
      adventureDesc:
        "Zonas de juego temáticas que despiertan la imaginación y la aventura",
      equipmentSafety: "Equipo Diseñado para la Seguridad de los Niños",
      equipmentDesc:
        "¡Todo nuestro equipo de juego cumple o supera los estándares de seguridad y se inspecciona y mantiene regularmente. Priorizamos la seguridad de su hijo mientras garantizamos la máxima diversión!",
    },
    safety: {
      title: "Aviso de Seguridad Importante",
      gripSocksRequired: "Calcetines Antideslizantes Requeridos",
      gripSocksDesc:
        "Todos los niños deben usar calcetines antideslizantes por seguridad mientras juegan en nuestra instalación. Esto ayuda a prevenir resbalones y caídas en nuestro equipo de juego.",
      ...
      mandatoryNote:
        "Los calcetines antideslizantes son obligatorios para todos los niños. Si no tiene calcetines antideslizantes, puede comprarlos en nuestra instalación antes de comenzar a jugar.",
    },
    admission: {
      title: "Admisión Diaria",
      subtitle:
        "¡Acceso de juego todo el día con diversión ilimitada para sus pequeños!",
      ...
      allDayAccessDesc:
        "Juegue todo el tiempo que quiera durante el horario de operación",
    ...
    groups: {
      ...
      callAheadDesc:
        "Por favor contáctenos con anticipación para programar su visita de grupo y asegurarnos de que podamos acomodar a su grupo.",
      phone: "Teléfono:",
    ...
    birthday: {
      ...
      subtitle:
        "¡Haga que el cumpleaños de su hijo sea inolvidable con nuestros paquetes de fiesta todo incluido!",
      ...
      readyToBookDesc:
        "¡Contáctenos hoy para reservar la fecha de su fiesta y hacer que la celebración de cumpleaños de su hijo sea extra especial!",
    },
    monthly: {
      title: "Pases Mensuales",
      subtitle:
        "¡Juego ilimitado durante un mes completo - el mejor valor para visitantes frecuentes!",
      ...
      greatValueDesc:
        "¡Visite solo 5 veces y ya habrá ahorrado dinero en comparación con la admisión diaria! Perfecto para familias que aman jugar a menudo.",
    ...
    requirements: {
      ...
      subtitle:
        "Por favor revise los requisitos de nuestra instalación antes de su visita",
      waiverRequirement: "Requisito de Exención",
      waiverDesc:
        "Todos los niños deben tener una exención firmada antes de jugar.",
      waiverIncludes:
        "Los padres o tutores legales deben completar y firmar una exención de responsabilidad integral para cada niño antes de que puedan acceder a nuestras áreas de juego. Esta exención incluye:",
      acknowledgment:
        "Reconocimiento de riesgos inherentes en actividades de juego físico",
      ...
      gripSocksDesc:
        "Se requieren calcetines antideslizantes para todos los niños.",
      gripSocksHelps:
        "Por razones de seguridad e higiene, todos los niños deben usar calcetines antideslizantes mientras juegan en nuestra instalación. Esta política ayuda a:",
      ...
      includedAdultsDesc:
        "Cada admisión de niño incluye 2 adultos gratis para supervisar y acompañar al niño durante el juego.",
      mustRemain:
        "Los adultos deben permanecer en las instalaciones para supervisar a sus hijos en todo momento.",
      additionalAdults: "Adultos Adicionales",
      additionalAdultsDesc:
        "Cada adulto adicional más allá de los 2 adultos incluidos requiere una tarifa de admisión separada.",
      importantReminders: "Recordatorios Importantes",
      parentsRemain:
        "Los padres/tutores deben permanecer en las instalaciones durante la visita de su hijo",
      childrenSupervised:
        "Los niños deben ser supervisados por un adulto en todo momento",
      facilityAges:
        "La instalación está diseñada para niños de 6 meses a 10 años",
      foodDrinks:
        "Los alimentos y bebidas están permitidos solo en áreas designadas",
      followRules:
        "Por favor siga todas las reglas de seguridad publicadas e instrucciones del personal",
    ...
    gallery: {
      ...
      photoLabel: "Foto",
      visitUs:
        "¡Visítenos para experimentar la diversión en persona! Síguenos en las redes sociales para más fotos y actualizaciones.",
    },
    contact: {
      title: "Contáctenos",
      subtitle:
        "Póngase en contacto con nosotros para reservas, preguntas o información de visita",
      address: "Dirección",
      phone: "Teléfono",
      email: "Correo Electrónico",
      hours: "Horario",
    ...
    waiver: {
      ...
      childrenInfoDesc:
        "Ingrese información para hasta 6 niños (al menos uno requerido)",
      child: "Niño",
      ...
      agreeRequired:
        "Por favor acepte los términos de la exención de responsabilidad y liberación de fotos",
    ...
    employee: {
      ...
      matchingCriteria:
        "Exenciones que coinciden con sus criterios de búsqueda",
      mostRecent: "Las 5 exenciones enviadas más recientemente",
      loadingWaivers: "Cargando exenciones...",
      failedToLoad:
        "Error al cargar exenciones. Por favor intente de nuevo más tarde.",
      ...
      childrenInfo: "Información de los Niños",
      agreedToTerms:
        "Aceptó la exención de responsabilidad y liberación de fotos",
