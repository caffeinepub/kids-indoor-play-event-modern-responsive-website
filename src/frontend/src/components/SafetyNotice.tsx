...
export default function SafetyNotice() {
  return (
    <section
      id="safety-notice"
      className="py-16 bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50"
    >
          ...
          <div className="p-8 sm:p-12">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      All children must wear grip socks for safety while playing
                      in our facility. This helps prevent slips and falls on our
                      play equipment.
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-8 bg-yellow-50 rounded-xl p-6 border-2 border-yellow-200">
              <p className="text-center text-gray-700 text-lg">
                <strong className="text-orange-600">Please Note:</strong> Grip
                socks are mandatory for all children. If you don't have grip
                socks, you can purchase them at our facility before play begins.
              </p>
            </div>
          </div>
        </div>
