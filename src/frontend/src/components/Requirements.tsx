import { AlertCircle, FileText, ShieldCheck, Users } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
            ...
            <div className="space-y-4 text-gray-700">
              <p className="text-lg">
                <strong>
                  All children must have a signed waiver before play.
                </strong>
              </p>
              <p>
                Parents or legal guardians must complete and sign a
                comprehensive liability waiver for each child before they can
                access our play areas. This waiver includes:
              </p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>
                For safety and hygiene reasons, all children must wear grip
                socks while playing in our facility. This policy helps:
              </p>
              <ul className="space-y-2 ml-6">
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-6 border border-orange-200">
              ...
              <p className="text-gray-700 mb-2">
                Each child admission includes <strong>2 free adults</strong> to
                supervise and accompany the child during play.
              </p>
              <p className="text-sm text-gray-600">
                Adults must remain on premises to supervise their children at
                all times.
              </p>
            </div>
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-6 border border-red-200">
              ...
              <p className="text-gray-700">
                Each additional adult beyond the 2 included adults requires a
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>
                    Parents/guardians must remain on premises during their
                    child's visit
                  </span>
                </li>
                <li className="flex items-start">
