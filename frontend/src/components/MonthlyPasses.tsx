...
import { Calendar, Infinity, Star, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <Infinity className="w-12 h-12 text-purple-600" />
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 sm:p-12">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 mb-8 border border-purple-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Unlimited Visits</p>
                      <p className="text-sm text-gray-600">Come as often as you like</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-purple-600 flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="font-semibold text-gray-900">All-Day Access</p>
                      <p className="text-sm text-gray-600">Stay as long as you want</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-purple-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Valid any day we're open</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-purple-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Pay once, play all month</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 rounded-xl p-6 border-2 border-yellow-200 mb-8">
                ...
                <p className="text-gray-700 text-center">
                  Visit just <strong>5 times</strong> and you've already saved money compared to daily admission! 
                  Perfect for families who love to play often.
                </p>
              </div>
