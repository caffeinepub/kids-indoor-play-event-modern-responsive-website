      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">{t.hero.hours}</h3>
          ...
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">{t.hero.ages}</h3>
          ...
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">{t.hero.location}</h3>
