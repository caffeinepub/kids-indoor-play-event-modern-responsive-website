          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>
                ...
                <br />
                <a href="tel:4057249947" className="hover:text-white transition-colors">
                  (405) 724-9947
                </a>
              </li>
              <li>
                ...
                <br />
                <a href="mailto:kids405llc@gmail.com" className="hover:text-white transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              ...
              <p className="flex items-center justify-center gap-2 text-gray-400 text-sm sm:text-base">
                © 2025. Built with <Heart className="w-4 h-4 text-red-500 fill-current" /> using{' '}
                <a
