              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="parentName" className="text-sm sm:text-base">Full Name *</Label>
                      <Input
                        id="parentName"
                        required
                    ...
                    <div>
                      <Label htmlFor="parentEmail" className="text-sm sm:text-base">Email Address *</Label>
                      <Input
                        id="parentEmail"
                        type="email"
                        required
                    ...
                    <div>
                      <Label htmlFor="parentPhone" className="text-sm sm:text-base">Phone Number *</Label>
                      <Input
                        id="parentPhone"
                        type="tel"
                        required
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {formData.children.map((child, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200">
                        <p className="text-sm sm:text-base font-semibold text-gray-900 mb-3 sm:mb-4">Child {index + 1}</p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                          <div>
                            <Label htmlFor={`childName${index}`} className="text-xs sm:text-sm">Child's Full Name</Label>
                            <Input
                              id={`childName${index}`}
                              value={child.name}
                          ...
                          <div>
                            <Label htmlFor={`childBirthday${index}`} className="text-xs sm:text-sm">Birthday (Optional)</Label>
                            <Input
                  ...
                  <div className="bg-blue-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border-2 border-blue-200">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setFormData({ ...formData, agreeUnifiedTerms: checked as boolean })}
                        className="mt-1"
                      />
                      <Label htmlFor="agreeUnifiedTerms" className="text-sm sm:text-base leading-relaxed cursor-pointer">
                        <strong className="text-gray-900">I agree to the Liability Waiver and Photo Release:</strong>
                        <span className="text-gray-700"> I have read and understand the comprehensive liability waiver and photo release above. I acknowledge the risks involved, agree to release KIDS Indoor Play & Event from all liability, agree to supervise my children at all times, and authorize the use of photographs and videos of my child(ren) for promotional purposes.</span>
                      </Label>
                    </div>
                  </div>
                </div>
